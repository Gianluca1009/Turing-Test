...
function Index() {
  ...
  return (
    <div className="relative h-screen flex items-center justify-center bg-black overflow-hidden">
      ...
      {/* Contenuto centrale */}
      <div className="relative bg-gray-900 bg-opacity-90 border border-green-400 rounded-3xl shadow-lg p-12 max-w-md w-full text-center z-10">
        <h1 className="text-4xl font-extrabold text-green-400 mb-6 tracking-wider">
        ...
        <div className="flex flex-col gap-5">
          <button
            ...
            className="bg-transparent border-2 border-green-400 hover:bg-green-400 hover:text-black text-green-400 py-4 px-8 rounded-xl font-semibold transition"
          >
            Vai alla Chat
          </button>
        </div>
